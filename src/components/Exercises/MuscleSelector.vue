    ...
    <main>
      <div class="muscle-groups">
        <input
          ...
          :key="muscle"
          type="checkbox"
          class="muscles-helper"
          :class="muscle"
          :checked="selectedMuscle.toLowerCase() === muscle"
        />
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            >
              ...
              <g id="Back-Muscles">
                <g>
                  <g id="Trapezius" @click.prevent="selectMuscle('Trapezius')">
                    <g>
                      <path
                  ...
                  <g id="Lats" @click.prevent="selectMuscle('Lats')">
                    <path
                  ...
                  <g id="Triceps" @click.prevent="selectMuscle('Triceps')">
                    <path
                  ...
                  <g id="Forearms" @click.prevent="selectMuscle('Forearms')">
                    <path
                  ...
                  <g id="Glutes" @click.prevent="selectMuscle('Glutes')">
                    <path
                  ...
                  <g
                    id="Hamstrings"
                    @click.prevent="selectMuscle('Hamstrings')"
                  >
                    <path
                  ...
                  <g id="Calves" @click.prevent="selectMuscle('Calves')">
                    <path
              ...
              <g id="Front-Muscles">
                <g id="Deltoids" @click.prevent="selectMuscle('Deltoids')">
                  <path
                ...
                <g id="Biceps" @click.prevent="selectMuscle('Biceps')">
                  <path
                ...
                <g id="Pectorals" @click.prevent="selectMuscle('Pectorals')">
                  <path
                ...
                <g id="Obliques" @click.prevent="selectMuscle('Obliques')">
                  <path
                ...
                <g id="Abs" @click.prevent="selectMuscle('Abs')">
                  <path
                ...
                <g id="Quads" @click.prevent="selectMuscle('Quads')">
                  <path
                ...
                <g id="Adductors" @click.prevent="selectMuscle('Adductors')">
                  <path
...
export default {
  ...
  methods: {
    selectMuscle(muscleName) {
      if (this.selectedMuscle === muscleName) this.selectedMuscle = "";
      else this.selectedMuscle = muscleName;

      this.$emit("selectMuscle", this.selectedMuscle);
    },
  },
...
.muscle-groups {
  ...
  @each $muscle in $groups {
    ...
    label[for="#{$muscle}"]:hover ~ div svg ##{$upper} path {
      opacity: 0.75;
    }
    .#{$muscle}:checked ~ div svg ##{$upper} path {
      opacity: 0.8;
      fill: $color-1 !important;
    }
  }
